  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 md:px-6">
        {/* Section heading */}
        {title && (
          <h2 className="mx-auto max-w-3xl text-balance text-center font-bold text-4xl text-white leading-tight tracking-tight md:text-5xl">
            {title}
          </h2>
        )}
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 lg:grid-cols-2">
          {features.map((feature) => (
            <article
              className="group flex flex-col overflow-hidden border border-white/10 bg-[#161b2e] transition-colors duration-300 hover:border-white/20 hover:bg-[#1e2540]"
              key={feature._key}
            >
              {/* Text content */}
              ...
              {/* Learn More footer */}
              <div className="border-white/10 border-t px-8 py-5">
